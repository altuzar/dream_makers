...
class DreamsTest < ApplicationSystemTestCase
  ...
  test "should create dream" do
    ...
    fill_in "Contactemail", with: @dream.contactEmail
    fill_in "Contactphone", with: @dream.contactPhone
    fill_in "Description", with: @dream.description
    check "Published" if @dream.published
    fill_in "Status", with: @dream.status
