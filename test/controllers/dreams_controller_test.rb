...
class DreamsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dream" do
    assert_difference("Dream.count") do
      post dreams_url, params: { dream: { contactEmail: @dream.contactEmail, contactPhone: @dream.contactPhone, description: @dream.description, published: @dream.published, status: @dream.status } }
    end
  ...
  test "should update dream" do
    patch dream_url(@dream), params: { dream: { contactEmail: @dream.contactEmail, contactPhone: @dream.contactPhone, description: @dream.description, published: @dream.published, status: @dream.status } }
